                ...
                <div class="navbar-header">
                    ...
                    <div class="d-flex">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right p-0"
                                ...
                                <div class="p-3">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-auto">
                                            <a href="tables-datatable.html#!" class="small"> View All</a>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="dropdown d-inline-block">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                <!-- item-->
                                <a class="dropdown-item" href="tables-datatable.html#"><i class="bx bx-user font-size-16 align-middle mr-1"></i> Profile</a>
                                <a class="dropdown-item" href="tables-datatable.html#"><i class="bx bx-wallet font-size-16 align-middle mr-1"></i> My Wallet</a>
